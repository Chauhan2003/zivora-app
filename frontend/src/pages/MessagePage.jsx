...
import { Phone, Video, Info, Send, MessageSquare, Search, X } from "lucide-react";
...
const MessagePage = () => {
  ...
  return (
    <div className="w-full h-screen flex bg-background">
      ...
      <div className="w-full md:w-[360px] border-r border-gray-300 dark:border-[#363636] flex flex-col shrink-0">
      ...
      <div className="hidden md:flex flex-1 flex-col min-w-0">
        {selectedConv ? (
          <>
            {/* Chat Header */}
            <div className="h-16 px-6 border-b border-gray-300 dark:border-[#363636] flex items-center justify-between shrink-0">
              <button
            ...
            {/* Messages */}
            <div className="flex-1 overflow-y-auto disableScrollbar px-6 py-4 flex flex-col gap-1">
              {messages.length === 0 ? (
            ...
            {/* Message Input */}
            <div className="px-6 py-4 border-t border-gray-300 dark:border-[#363636] shrink-0">
              <div className="flex items-center gap-3 bg-gray-100 dark:bg-[#262626] rounded-full px-5 py-2.5">
                <input
                  type="text"
                  value={text}
